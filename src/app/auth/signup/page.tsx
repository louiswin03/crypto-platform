  ...
  return (
    <div className="min-h-screen bg-[#0A0E1A] text-[#F9FAFB] relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/4 left-1/4 w-[800px] h-[800px] bg-gradient-to-br from-[#2563EB]/10 via-[#4F46E5]/6 to-transparent rounded-full blur-[100px]"></div>
        <div className="absolute bottom-1/4 right-1/4 w-[600px] h-[600px] bg-gradient-to-tl from-[#F59E0B]/10 via-[#8B5CF6]/5 to-transparent rounded-full blur-[100px]"></div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-start space-x-3">
              <input
                type="checkbox"
                id="terms"
                className="mt-1 w-4 h-4 text-[#2563EB] border-gray-600 rounded focus:ring-[#2563EB] bg-gray-700"
                required
              />
              <label htmlFor="terms" className="text-sm text-gray-400">
                {t('auth.signup.terms1')}{' '}
                <Link href="#" className="text-[#2563EB] hover:text-[#8B5CF6] transition-colors">
