      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          ...
          <div className="glass-effect rounded-2xl p-8">
            <div className="w-14 h-14 bg-gradient-to-br from-[#16A34A] to-[#15803D] rounded-xl flex items-center justify-center mb-6">
        ...
        <div className="mt-12 glass-effect rounded-2xl p-8">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className="text-[#16A34A] font-semibold text-lg">OPÉRATIONNEL</span>
            </div>
          </div>
