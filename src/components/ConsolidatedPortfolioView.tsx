...
export default function ConsolidatedPortfolioView({ portfolio, onAddManualHolding, refreshTrigger }: ConsolidatedPortfolioViewProps) {
  ...
  const COLORS = ['#6366F1', '#8B5CF6', '#EC4899', '#F59E0B', '#10B981', '#3B82F6', '#EF4444', '#14B8A6', '#F97316', '#8B5CF6']
    ...
    <div className="glass-effect-strong rounded-2xl p-6 border border-gray-800/40 mt-6">
      ...
      {holdings.length > 0 && (
        <button
          ...
          className="w-full flex items-center justify-between p-4 rounded-xl bg-gradient-to-r from-[#6366F1]/10 to-[#8B5CF6]/10 border border-[#6366F1]/30 hover:border-[#6366F1]/50 transition-all group mb-4"
        >
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  {holding.image ? (
                    ...
                    <div className="w-10 h-10 bg-gradient-to-br from-[#6366F1] via-[#8B5CF6] to-[#A855F7] rounded-full flex items-center justify-center text-white font-bold text-sm shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            {largestPosition && (
              <div className="glass-effect rounded-xl p-4 border border-gray-800/40">
                ...
                <p className="text-[#6366F1] text-sm mt-1">{largestPositionPercent.toFixed(1)}% du portfolio</p>
              </div>
            )}
