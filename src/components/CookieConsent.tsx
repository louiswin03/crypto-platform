          ...
          <div className="p-6 md:p-8">
            <div className="flex items-start gap-4">
              <div className="flex-shrink-0">
                <div className="w-12 h-12 bg-[#6366F1]/20 rounded-xl flex items-center justify-center transition-transform hover:scale-110">
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-3">
                  <button
                    ...
                    className="px-6 py-2.5 bg-[#6366F1] hover:bg-[#5558E3] text-white rounded-xl font-medium transition-all hover:scale-105 hover:shadow-lg hover:shadow-[#6366F1]/50"
                  >
                    {t.acceptAll}
                  </button>
                  <button
                  ...
                  <button
                    ...
                    className="px-6 py-2.5 bg-transparent border border-gray-600 hover:border-[#6366F1] hover:bg-[#6366F1]/10 text-gray-300 hover:text-white rounded-xl font-medium transition-all hover:scale-105 flex items-center gap-2"
                  >
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1 mt-3 text-sm text-[#6366F1] hover:text-[#8B5CF6] transition-all hover:gap-2"
                >
            ...
            {showSettings && (
              <div className="mt-6 pt-6 border-t border-gray-700/50 space-y-4">
                {/* Cookies nécessaires */}
                <div className="flex items-start justify-between gap-4 p-4 rounded-xl bg-[#16A34A]/5 border border-[#16A34A]/20">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      <h4 className="font-semibold text-[#F9FAFB]">{t.necessary}</h4>
                      <span className="px-2 py-0.5 bg-[#16A34A]/20 text-[#16A34A] text-xs rounded-md font-medium">
                  ...
                  <div className="flex-shrink-0">
                    <div className="w-12 h-6 bg-[#16A34A] rounded-full flex items-center justify-end px-1 cursor-not-allowed opacity-75">
                  ...
                  <div className="flex-shrink-0">
                    <button
                      ...
                      className={`w-12 h-6 rounded-full flex items-center px-1 transition-all hover:scale-110 ${
                        preferences.functional ? 'bg-[#6366F1] hover:bg-[#5558E3] justify-end' : 'bg-gray-600 hover:bg-gray-500 justify-start'
                      }`}
                    >
                      <div className="w-4 h-4 bg-white rounded-full shadow-lg"></div>
                    </button>
