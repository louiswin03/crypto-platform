        ...
        <div className="flex items-center justify-center min-h-screen p-4">
          <div className="relative w-full max-w-md">
            <div className="glass-effect rounded-3xl p-8 border border-gray-800/40 text-center">
              <div className="relative inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-[#6366F1] via-[#8B5CF6] to-[#A855F7] rounded-2xl mb-6 shadow-2xl">
              ...
              <div className="space-y-4">
                <Link
                  href="/auth/signin"
                  className="w-full bg-gradient-to-r from-[#6366F1] via-[#8B5CF6] to-[#A855F7] hover:from-[#5B21B6] hover:via-[#7C3AED] hover:to-[#9333EA] text-white font-bold py-3 px-4 rounded-xl transition-all duration-300 shadow-xl hover:shadow-[#6366F1]/40 hover:scale-105 block text-center"
                >
                  Se connecter
                </Link>
                ...
                <Link
                  href="/auth/signup"
                  className="w-full border-2 border-gray-700 text-[#F9FAFB] font-semibold py-3 px-4 rounded-xl hover:border-[#6366F1] hover:bg-[#6366F1]/10 transition-all duration-300 block text-center"
                >
                  Créer un compte
                </Link>
                ...
                <Link
                  href="/"
                  className="text-gray-400 hover:text-[#6366F1] transition-colors text-sm block mt-6"
                >
                  ← Retour à l'accueil
                </Link>
              </div>
